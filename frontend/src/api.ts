...
export interface AppSettings { owner_name: string; owner_email: string; review_mode: string; confidence_threshold: number; telegram_claim_code: string; telegram_claimed: boolean; ai_provider: string; ai_model: string; ai_configured: boolean; base_currency: string; }
